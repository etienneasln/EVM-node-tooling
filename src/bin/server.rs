...
async fn answer_query(query: web::Json<Sqlquery>) -> Result<impl Responder,ServerError>{
    ...
    let response=match  method_requested{
            ...
            "select_blueprint_range"=>{
                ...
                SqlResponse::BlueprintRangeSelect{
                    idandpayloads
                }
            }
            ...
            "insert_block"=>{
                ...
                SqlResponse::NumbersofRowsAffected { number:insert_result }
            }
            "select_block_with_level"=>{
                let id:i32=extract_parameter(&query.params[0])?;
                let block=Block::select_with_level(connection, id)?;
                SqlResponse::BlockSelect{
                    block
                }
            }
            ...
            "select_pending_confirmation_with_level"=>{
                ...
                SqlResponse::PendingConfirmationSelect{
                    hash
                }
            }
            "delete_pending_confirmation_with_level"=>{
                let level:i32=extract_parameter(&query.params[0])?;
                let delete_with_level_result=PendingConfirmation::delete_with_level(connection, level)?;
                SqlResponse::NumbersofRowsAffected{
            ...
            "count_pending_confirmations"=>{
                ...
                SqlResponse::PendingConfirmationCount{ 
                    count 
                }
            }
            "insert_transaction"=>{
            ...
            "select_transaction_receipt"=>{
                let hash:Vec<u8>=extract_parameter(&query.params[0])?;
                let (block_hash,block_number,index_,hash,
                    from_,to_,receipt_fields)=
            ...
            "select_transaction_receipts_from_block_number"=>{
                ...
                let receipts=Transaction::select_receipts_from_block_number(connection, block_number)?;
                SqlResponse::TransactionReceipts{
                    receipts
                }
            }
            ...
            "select_transaction_objects_from_block_number"=>{
                ...
                SqlResponse::TransactionObjects{
                    objects
                }
            }
            ...
            "get_smart_rollup_address"=>{
                ...
                SqlResponse::MetadataSmartRollupAddress { 
                    address
                }
            }
            "insert_history_mode"=>{
            ...
            "get_history_mode"=>{
                ...
                SqlResponse::MetadataHistoryMode { 
                    history_mode
                }
            }
            _=>{
