...
fn main(){
    ...
    if database_url!=":memory:"{
        ...
        let transactions_receipts=Transaction::select_receipts_from_block_number(connection, select_index).unwrap();
        let transaction_objects=Transaction::select_objects_from_block_number(connection, select_index).unwrap();
